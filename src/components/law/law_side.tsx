...
export const LawSideComponent: React.FC<{
  ...
  // 改正法令判定フラグ
  const isAmendmentLaw =
    revisionInfo?.amendmentLawId !== undefined &&
    revisionInfo?.amendmentLawId !== null &&
    revisionInfo?.amendmentLawId != "";
  ...
  const amendmentPromulgateDate =
    !isAmendmentLaw || revisionInfo?.amendmentPromulgateDate === undefined
      ? ""
